...
-- Optional full cover to ensure visual block
local cover = Instance.new("Frame")
cover.Size = UDim2.new(1, 0, 1, 0)
cover.Position = UDim2.new(0, 0, 0, 0)
cover.BackgroundColor3 = Color3.new(0, 0, 0)
cover.BackgroundTransparency = 0 -- fully opaque
cover.ZIndex = 10
...
-- Percentage text that moves with the bar
